...
const SignUp = () => {
  ...
  return (
    <div 
      className={`signup-page ${backgroundLoaded ? 'background-loaded' : ''} ${backgroundError ? 'background-error' : ''}`}
      style={{
        backgroundImage: backgroundLoaded && !backgroundError ? 'url(./Create.png)' : 'none'
      }}
    >
